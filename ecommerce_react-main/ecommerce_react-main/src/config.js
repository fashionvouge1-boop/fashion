...
const isWrongRenderHost =
  envApiUrl.includes("fashion-vouge-api.onrender.com") ||
  envApiUrl.includes("fashion-api.onrender.com");
...
export const PHONEPE_NODE_URL =
  ...
  !process.env.REACT_APP_PHONEPE_NODE_URL.includes("fashion-api.onrender.com")
    ? process.env.REACT_APP_PHONEPE_NODE_URL
    : `${API_URL}/api/`;
